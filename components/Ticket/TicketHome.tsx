...
const FLAVORS = {
  ...
  nextjs: {
    ...
    figure: 'flex items-end mb-[80px] mr-[40px]'
  },
  nuxt: {
    component: ({ className }: { className: string }) => (
      <svg
  ...
  java: {
    ...
    figure: 'flex items-end mb-[60px] mr-[20px]'
  },
  csharp: {
    component: ({ className }: { className: string }) => (
      <svg
  ...
  scala: {
    ...
    figure: 'flex items-end mb-[40px] mr-[-30px]'
  },
  vim: {
    component: ({ className }: { className: string }) => (
      <svg
...
const TicketHome = ({ initialFlavor }: TicketHomeProps) => {
  ...
  const handleShare = async () => {
    ...
    const text = `¡Se viene la fiesta del administrador del grupo!
  
🛁 Vamos a tirar la bañera por la ventana
🎅🏻 Tenemos para escabiar hasta los jarabes del abuelo
🎁 +256 regalos y premios
  
  No te quedes afuera pedazo de gobernado.
