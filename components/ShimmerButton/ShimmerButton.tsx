...
const ShimmerButton = ({
  ...
  return (
    <button
      ...
      className={cn(
        'group relative cursor-pointer overflow-hidden whitespace-nowrap border border-white/30 px-6 py-4 [background:var(--bg)] [border-radius:var(--radius)] ',
    ...
    >
      ...
      <div className='pointer-events-none relative z-10 flex items-center justify-center text-lg font-semibold text-white md:text-xl'>
        {children}
      </div>
    </button>
  )
